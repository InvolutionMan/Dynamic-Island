...
Fantastic Island 基于开源项目 [open-vibe-island](https://github.com/Octane0411/open-vibe-island) 二次开发，是一个面向 macOS 刘海区域开放式的可扩展应用。
...
Fantastic Island 源自开源项目 [open-vibe-island](https://github.com/Octane0411/open-vibe-island)，但真正想做的是基于壳架构和模组化扩展，让你可以按需定制属于自己的岛；比如你可以集成一个 todo 进来（虽然我不确定体验是否 ok）
